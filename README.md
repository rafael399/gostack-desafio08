Pego de Rocketseat **[Desafio08](https://github.com/Rocketseat/bootcamp-gostack-desafios/blob/master/desafio-fundamentos-react-native/README.md)**
...
- Executar o comando `cd ios && pod install && cd ..` para fazer a instalação dos pods do ios
- Execute a fake API com o comando `yarn json-server server.json -p 3333`
- Caso queira rodar a aplicação execute o comando `yarn ios` ou `yarn android` na pasta da da aplicação
